"""
Django settings for salt_fish project.
...
SECRET_KEY = 'wf+4!q*&h5s0+0f0ww*qq^c()+k!los=_8ey7#7!f9#l701gbf'
...
WSGI_APPLICATION = 'salt_fish.wsgi.application'
...
GOOD_IMAGE_DIR = os.path.join(BASE_DIR, 'good', 'images')
